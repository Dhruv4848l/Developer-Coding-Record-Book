...
const getHackerRankStats = () => {
  ...
  return {
    profile: {
      ...
      name: "Dhruv Maji",
      globalRank: 22122,
      // Only count programmable/coding problems solved on HackerRank
      // This excludes badges, certifications, and non-coding activities
      problemsSolved: 4, // Only actual programming problems solved
      totalSubmissions,
      activeDays,
      currentStreak,
      longestStreak,
...
Deno.serve(async (req) => {
  ...
  try {
    const stats = getHackerRankStats();
